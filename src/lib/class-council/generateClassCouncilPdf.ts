...
import { HUB_NAME, SCHOOL_LOCATION, SCHOOL_NAME, SCHOOL_SHORT_NAME } from "@/constants/main/school";
...
export async function generateClassCouncilPdf(data: ClassCouncilPdfData): Promise<Buffer> {
  ...
  doc.font("Helvetica").fontSize(7.5).fillColor(COLORS.muted)
    .text(`Documento gerado pelo ${HUB_NAME}.`, PAGE_MARGIN, doc.y, { width: contentWidth });
