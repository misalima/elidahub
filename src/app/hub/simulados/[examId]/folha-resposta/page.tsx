...
// Modo duplo (A5 compacto):
//   ≤30  → 2 colunas, 15 itens, 14pt
//   31-45 → 3 colunas, 15 itens, 14pt
//   >45  → 3 colunas, 19 itens, 12pt
//
// Modo normal (A4 completo):
//   Sempre 20 itens/coluna, 14pt, quantas colunas forem necessárias
...
function BubbleGrid({
  ...
  compact?: boolean;
  answers?: string[]; // answers[i] = letter for question i+1 (1-indexed), e.g. 'A'
}) {
...
export default function FolhaRespostaPage({ params }: FolhaRespostaPageProps) {
