...
describe("parseCreateManagedUserInput", () => {
  ...
  it.each([
    [{ email: "invalido", fullName: "Maria Silva", role: "admin", password: "Senha123" }],
    [{ email: "maria@escola.com", fullName: "M", role: "admin", password: "Senha123" }],
    [{ email: "maria@escola.com", fullName: "Maria Silva", role: "professor", password: "Senha123" }],
    [{ email: "maria@escola.com", fullName: "Maria Silva", role: "admin", password: "curta" }],
