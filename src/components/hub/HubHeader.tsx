...
import { HUB_NAME, SCHOOL_SHORT_NAME } from "@/constants/main/school";
    ...
    >
      <div className="mx-auto flex h-[4.5rem] w-full max-w-7xl items-center justify-between gap-3 px-4 sm:px-6 lg:px-8 min-[1800px]:max-w-[1600px] min-[2400px]:max-w-[1800px]">
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          <Link
            href="/hub"
            className="group flex min-w-0 items-center gap-3 rounded-2xl outline-none focus-visible:ring-2 focus-visible:ring-primary/60 focus-visible:ring-offset-2 dark:focus-visible:ring-offset-slate-950"
            aria-label={`Ir para o painel do ${HUB_NAME}`}
          >
            <span className="relative flex size-11 shrink-0 items-center justify-center overflow-hidden rounded-2xl border border-gold/70 bg-gold/10 shadow-[0_8px_24px_-12px_rgba(208,178,90,0.65)] transition-transform duration-300 group-hover:-translate-y-0.5 dark:border-gold/35 dark:bg-gold/10">
              <Image
                src="/logo_escola.png"
                alt=""
                width={44}
